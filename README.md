...
Core `/status` dumps live WatchEngine facts; `/help` says `/status` returns those facts. Rebuild on a Mac and check the lines match live state. Do not claim that dump Mac-proven until a Mac checks it.
