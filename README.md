...
| Lid close | Brightness → user floor **%** (**5–40%**, default **15%**) + keyboard backlight off |
...
| Agents | Busy stays awake; settled idle after user settle grace (default **90s**) allows sleep |
...
5. Close the lid when ready. Brightness goes to the floor % (**5–40%**, default **15%**); keyboard goes dark; the Mac stays up.
...
**Agents** mode: Agrypnos polls local processes and session files for Cursor, Claude Code, and Codex. If they look busy, the watch holds. After they look idle for the settle grace (default **90s**), Agrypnos *allows sleep* (drops `SleepDisabled`). It does not try to be every provider on earth.
...
- **User-settable next (still popover):** brightness floor **%** (**5–40%**, default **15%**), Agents settle grace (default **90s**), lid-open ramp **1 / 2 / 3 s** (default **2s**).
